...
public abstract class PlayerEntity extends LivingEntity {
   ...
   public static Optional<Vector3d> func_234567_a_(ServerWorld p_234567_0_, BlockPos p_234567_1_, boolean p_234567_2_, boolean p_234567_3_) {
      ...
      if (block instanceof RespawnAnchorBlock && blockstate.get(RespawnAnchorBlock.field_235559_a_) > 0 && RespawnAnchorBlock.func_235562_a_(p_234567_0_)) {
         ...
         if (!p_234567_3_ && optional.isPresent()) {
            p_234567_0_.setBlockState(p_234567_1_, blockstate.with(RespawnAnchorBlock.field_235559_a_, Integer.valueOf(blockstate.get(RespawnAnchorBlock.field_235559_a_) - 1)), 3);
         }
   ...
   public ITextComponent getDisplayName() {
      ...
      iformattabletextcomponent = iformattabletextcomponent.func_230529_a_(ScorePlayerTeam.func_237500_a_(this.getTeam(), this.getName()));
   ...
   public ITextComponent getDisplayNameAndUUID() {
      return (new StringTextComponent("")).func_230529_a_(this.getName()).func_240702_b_(" (").func_240702_b_(this.gameProfile.getId().toString()).func_240702_b_(")");
   }
