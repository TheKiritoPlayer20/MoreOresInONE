...
public class PiglinTasks {
   ...
   private static void func_234502_d_(Brain<PiglinEntity> p_234502_0_) {
      p_234502_0_.func_233699_a_(Activity.field_234623_m_, 10, ImmutableList.<net.minecraft.entity.ai.brain.task.Task<? super PiglinEntity>>of(new PickupWantedItemTask<>(PiglinTasks::func_234455_E_, 1.0F, true, 9), new ForgetAdmiredItemTask(9)), MemoryModuleType.field_234080_N_);
   }
   ...
   protected static boolean func_234489_b_(PiglinEntity p_234489_0_, ItemStack p_234489_1_) {
      return !func_234453_C_(p_234489_0_) && !func_234451_A_(p_234489_0_) && p_234489_0_.func_234421_eJ_() && func_234492_b_(p_234489_1_.getItem());
   }
   ...
   protected static void func_234497_c_(PiglinEntity p_234497_0_, LivingEntity p_234497_1_) {
      if (func_234506_e_(p_234497_1_)) {
         ...
         if (p_234497_1_.getType() == EntityType.field_233588_G_) {
