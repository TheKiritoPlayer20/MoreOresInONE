...
public class CampfireBlock extends ContainerBlock implements IWaterLoggable {
   ...
   public static boolean func_235474_a_(World p_235474_0_, BlockPos p_235474_1_) {
      for(int i = 1; i <= 5; ++i) {
         ...
         boolean flag = VoxelShapes.compare(field_226912_f_, blockstate.getCollisionShape(p_235474_0_, blockpos, ISelectionContext.dummy()), IBooleanFunction.AND);//Forge fix: MC-201374
         if (flag) {
