...
public class MobSpawnInfo {
   ...
   public static class Builder {
      protected final Map<EntityClassification, List<MobSpawnInfo.Spawners>> field_242567_a = Stream.of(EntityClassification.values()).collect(ImmutableMap.toImmutableMap((p_242578_0_) -> {
         return p_242578_0_;
      }, (p_242574_0_) -> {
         return Lists.newArrayList();
      }));
      protected final Map<EntityType<?>, MobSpawnInfo.SpawnCosts> field_242568_b = Maps.newLinkedHashMap();
