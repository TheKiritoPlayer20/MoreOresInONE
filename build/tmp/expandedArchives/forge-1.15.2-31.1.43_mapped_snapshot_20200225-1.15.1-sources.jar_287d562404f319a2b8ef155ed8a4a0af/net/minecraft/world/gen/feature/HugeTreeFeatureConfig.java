...
public class HugeTreeFeatureConfig extends BaseTreeFeatureConfig {
   ...
   public static class Builder extends BaseTreeFeatureConfig.Builder {
      ...
      public HugeTreeFeatureConfig build() {
         return new HugeTreeFeatureConfig(this.trunkProvider, this.leavesProvider, this.field_227278_c_, this.field_227279_d_, this.field_227280_e_, this.field_227281_f_).setSapling(this.sapling);
      }
   }
}