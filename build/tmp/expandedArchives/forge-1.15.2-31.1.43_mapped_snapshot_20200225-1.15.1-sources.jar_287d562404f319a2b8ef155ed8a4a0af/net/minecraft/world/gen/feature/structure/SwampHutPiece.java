...
public class SwampHutPiece extends ScatteredStructurePiece {
   ...
   public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
      if (!this.isInsideBounds(p_225577_1_, p_225577_4_, 0)) {
         ...
         this.fillWithBlocks(p_225577_1_, p_225577_4_, 0, 4, 1, 6, 4, 1, blockstate, blockstate, false);
         this.fillWithBlocks(p_225577_1_, p_225577_4_, 0, 4, 2, 0, 4, 7, blockstate1, blockstate1, false);
         this.fillWithBlocks(p_225577_1_, p_225577_4_, 6, 4, 2, 6, 4, 7, blockstate2, blockstate2, false);
         this.fillWithBlocks(p_225577_1_, p_225577_4_, 0, 4, 8, 6, 4, 8, blockstate3, blockstate3, false);
         this.setBlockState(p_225577_1_, blockstate.with(StairsBlock.SHAPE, StairsShape.OUTER_RIGHT), 0, 4, 1, p_225577_4_);
         this.setBlockState(p_225577_1_, blockstate.with(StairsBlock.SHAPE, StairsShape.OUTER_LEFT), 6, 4, 1, p_225577_4_);
         this.setBlockState(p_225577_1_, blockstate3.with(StairsBlock.SHAPE, StairsShape.OUTER_LEFT), 0, 4, 8, p_225577_4_);
         this.setBlockState(p_225577_1_, blockstate3.with(StairsBlock.SHAPE, StairsShape.OUTER_RIGHT), 6, 4, 8, p_225577_4_);

         for(int i = 2; i <= 7; i += 5) {
            for(int j = 1; j <= 5; j += 4) {
               this.replaceAirAndLiquidDownwards(p_225577_1_, Blocks.OAK_LOG.getDefaultState(), j, -1, i, p_225577_4_);
            }
         }
         ...
         if (!this.witch) {
            ...
            if (p_225577_4_.isVecInside(new BlockPos(l, i1, k))) {
               this.witch = true;
               WitchEntity witchentity = EntityType.WITCH.create(p_225577_1_.getWorld());
               witchentity.enablePersistence();
               witchentity.setLocationAndAngles((double)l + 0.5D, (double)i1, (double)k + 0.5D, 0.0F, 0.0F);
               witchentity.onInitialSpawn(p_225577_1_, p_225577_1_.getDifficultyForLocation(new BlockPos(l, i1, k)), SpawnReason.STRUCTURE, (ILivingEntityData)null, (CompoundNBT)null);
               p_225577_1_.addEntity(witchentity);
            }
         }
