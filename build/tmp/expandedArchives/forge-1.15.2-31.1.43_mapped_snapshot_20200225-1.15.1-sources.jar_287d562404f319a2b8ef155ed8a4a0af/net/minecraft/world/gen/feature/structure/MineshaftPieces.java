      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         if (this.isLiquidInStructureBoundingBox(p_225577_1_, p_225577_4_)) {
            ...
            for(int j1 = 0; j1 < this.sectionCount; ++j1) {
               int k1 = 2 + j1 * 5;
               this.placeSupport(p_225577_1_, p_225577_4_, 0, 0, k1, 2, 2, p_225577_3_);
               this.placeCobWeb(p_225577_1_, p_225577_4_, p_225577_3_, 0.1F, 0, 2, k1 - 1);
               this.placeCobWeb(p_225577_1_, p_225577_4_, p_225577_3_, 0.1F, 2, 2, k1 - 1);
               this.placeCobWeb(p_225577_1_, p_225577_4_, p_225577_3_, 0.1F, 0, 2, k1 + 1);
               this.placeCobWeb(p_225577_1_, p_225577_4_, p_225577_3_, 0.1F, 2, 2, k1 + 1);
               this.placeCobWeb(p_225577_1_, p_225577_4_, p_225577_3_, 0.05F, 0, 2, k1 - 2);
               this.placeCobWeb(p_225577_1_, p_225577_4_, p_225577_3_, 0.05F, 2, 2, k1 - 2);
               this.placeCobWeb(p_225577_1_, p_225577_4_, p_225577_3_, 0.05F, 0, 2, k1 + 2);
               this.placeCobWeb(p_225577_1_, p_225577_4_, p_225577_3_, 0.05F, 2, 2, k1 + 2);
               if (p_225577_3_.nextInt(100) == 0) {
                  this.generateChest(p_225577_1_, p_225577_4_, p_225577_3_, 2, 0, k1 - 1, LootTables.CHESTS_ABANDONED_MINESHAFT);
               }

               if (p_225577_3_.nextInt(100) == 0) {
                  this.generateChest(p_225577_1_, p_225577_4_, p_225577_3_, 0, 0, k1 + 1, LootTables.CHESTS_ABANDONED_MINESHAFT);
               }

               if (this.hasSpiders && !this.spawnerPlaced) {
                  int l1 = this.getYWithOffset(0);
                  int i2 = k1 - 1 + p_225577_3_.nextInt(3);
            ...
            for(int l2 = 0; l2 <= 2; ++l2) {
               for(int i3 = 0; i3 <= i1; ++i3) {
                  int k3 = -1;
                  BlockState blockstate3 = this.getBlockStateFromPos(p_225577_1_, l2, -1, i3, p_225577_4_);
                  if (blockstate3.isAir() && this.getSkyBrightness(p_225577_1_, l2, -1, i3, p_225577_4_)) {
                     int l3 = -1;
                     this.setBlockState(p_225577_1_, blockstate, l2, -1, i3, p_225577_4_);
                  }
               }
            }
