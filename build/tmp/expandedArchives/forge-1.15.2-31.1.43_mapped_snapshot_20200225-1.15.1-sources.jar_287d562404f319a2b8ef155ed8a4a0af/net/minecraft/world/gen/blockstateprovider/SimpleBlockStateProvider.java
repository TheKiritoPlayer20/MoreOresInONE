...
public class SimpleBlockStateProvider extends BlockStateProvider {
   ...
   public <T> T serialize(DynamicOps<T> p_218175_1_) {
      ...
      builder.put(p_218175_1_.createString("type"), p_218175_1_.createString(Registry.BLOCK_STATE_PROVIDER_TYPE.getKey(this.blockStateProvider).toString())).put(p_218175_1_.createString("state"), BlockState.serialize(p_218175_1_, this.field_227405_b_).getValue());
