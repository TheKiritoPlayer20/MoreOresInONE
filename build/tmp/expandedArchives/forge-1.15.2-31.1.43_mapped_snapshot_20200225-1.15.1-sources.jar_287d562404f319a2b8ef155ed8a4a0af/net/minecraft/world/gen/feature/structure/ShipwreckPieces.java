...
public class ShipwreckPieces {
   ...
   public static class Piece extends TemplateStructurePiece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         if (k == 0) {
            j = p_225577_1_.getHeight(heightmap$type, this.templatePosition.getX(), this.templatePosition.getZ());
         } else {
            ...
            for(BlockPos blockpos2 : BlockPos.getAllInBoxMutable(this.templatePosition, blockpos1)) {
               int l = p_225577_1_.getHeight(heightmap$type, blockpos2.getX(), blockpos2.getZ());
               j += l;
               i = Math.min(i, l);
            }
         ...
         int i1 = this.isBeached ? i - blockpos.getY() / 2 - p_225577_3_.nextInt(3) : j;
