...
public class OverworldDimension extends Dimension {
   ...
   public ChunkGenerator<? extends GenerationSettings> createChunkGenerator() {
      ...
      if (worldtype == WorldType.FLAT) {
         ...
         SingleBiomeProviderSettings singlebiomeprovidersettings = biomeprovidertype.func_226840_a_(this.world.getWorldInfo()).setBiome(Biomes.PLAINS);
         ...
         if (jsonobject1 != null && jsonobject1.has("type") && jsonobject1.has("options")) {
            ...
            if (BiomeProviderType.VANILLA_LAYERED == biomeprovidertype3) {
               OverworldBiomeProviderSettings overworldbiomeprovidersettings1 = biomeprovidertype1.func_226840_a_(this.world.getWorldInfo());
