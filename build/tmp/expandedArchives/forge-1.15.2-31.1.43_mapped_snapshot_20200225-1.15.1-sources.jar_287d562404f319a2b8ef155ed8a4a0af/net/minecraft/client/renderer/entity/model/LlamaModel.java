...
public class LlamaModel<T extends AbstractChestedHorseEntity> extends EntityModel<T> {
   ...
   public LlamaModel(float p_i47226_1_) {
      ...
      this.field_228273_a_.addBox(-2.0F, -14.0F, -10.0F, 4.0F, 4.0F, 9.0F, p_i47226_1_);
      this.field_228273_a_.setRotationPoint(0.0F, 7.0F, -6.0F);
      this.field_228273_a_.setTextureOffset(0, 14).addBox(-4.0F, -16.0F, -6.0F, 8.0F, 18.0F, 6.0F, p_i47226_1_);
      this.field_228273_a_.setTextureOffset(17, 0).addBox(-4.0F, -19.0F, -4.0F, 3.0F, 3.0F, 2.0F, p_i47226_1_);
      this.field_228273_a_.setTextureOffset(17, 0).addBox(1.0F, -19.0F, -4.0F, 3.0F, 3.0F, 2.0F, p_i47226_1_);
      this.field_228274_b_ = new ModelRenderer(this, 29, 0);
      this.field_228274_b_.addBox(-6.0F, -10.0F, -7.0F, 12.0F, 18.0F, 10.0F, p_i47226_1_);
