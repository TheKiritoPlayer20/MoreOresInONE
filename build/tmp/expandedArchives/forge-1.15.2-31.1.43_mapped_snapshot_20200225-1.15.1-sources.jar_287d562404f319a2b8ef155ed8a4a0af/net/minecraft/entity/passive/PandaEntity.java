...
public class PandaEntity extends AnimalEntity {
   ...
   private static final EntityPredicate field_229963_bD_ = (new EntityPredicate()).setDistance(8.0D).allowFriendlyFire().allowInvulnerable();
            ...
            if (!this.func_220691_h()) {
               if (this.field_220694_f <= this.panda.ticksExisted) {
                  ...
                  if (this.panda.isServerWorld()) {
                     PlayerEntity playerentity = this.world.getClosestPlayer(PandaEntity.field_229963_bD_, this.panda);
                     this.panda.field_229964_bN_.func_229975_a_(playerentity);
                  }
               }
