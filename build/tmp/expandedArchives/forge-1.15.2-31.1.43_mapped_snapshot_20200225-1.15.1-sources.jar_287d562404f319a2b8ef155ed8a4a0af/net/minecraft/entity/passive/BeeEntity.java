...
public class BeeEntity extends AnimalEntity implements IFlyingAnimal {
   ...
   public class FindBeehiveGoal extends BeeEntity.PassiveGoal {
      ...
      public boolean func_225506_g_() {
         return BeeEntity.this.field_226369_bI_ != null && !BeeEntity.this.detachHome() && BeeEntity.this.func_226415_eI_() && !this.func_226476_d_(BeeEntity.this.field_226369_bI_) && BeeEntity.this.world.getBlockState(BeeEntity.this.field_226369_bI_).isIn(BlockTags.BEEHIVES);
      }
