      ...
      public boolean shouldExecute() {
         if (!FoxEntity.this.isSleeping() && this.creature.getAttackTarget() == null) {
            if (FoxEntity.this.world.isThundering()) {
               ...
               return FoxEntity.this.world.isDaytime() && FoxEntity.this.world.canSeeSky(blockpos) && !((ServerWorld)FoxEntity.this.world).func_217483_b_(blockpos) && this.func_220702_g();
            }
         } else {
            return false;
         }
