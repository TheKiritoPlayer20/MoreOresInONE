...
public class BannerTileEntityRenderer extends TileEntityRenderer<BannerTileEntity> {
   ...
   public void func_225616_a_(BannerTileEntity p_225616_1_, float p_225616_2_, MatrixStack p_225616_3_, IRenderTypeBuffer p_225616_4_, int p_225616_5_, int p_225616_6_) {
      if (p_225616_1_.getPatternList() != null) {
         float f = 0.6666667F;
         ...
         if (flag) {
            ...
            this.field_228834_c_.showModel = !p_225616_1_.func_226955_h_();
         } else {
         ...
         func_228837_a_(p_225616_1_, p_225616_3_, p_225616_4_, p_225616_5_, p_225616_6_, this.field_228833_a_, ModelBakery.field_229315_f_, true);
   ...
   public static void func_228837_a_(BannerTileEntity p_228837_0_, MatrixStack p_228837_1_, IRenderTypeBuffer p_228837_2_, int p_228837_3_, int p_228837_4_, ModelRenderer p_228837_5_, Material p_228837_6_, boolean p_228837_7_) {
      p_228837_5_.func_228308_a_(p_228837_1_, p_228837_6_.func_229311_a_(p_228837_2_, RenderType::func_228634_a_), p_228837_3_, p_228837_4_);
      ...
      for(int i = 0; i < 17 && i < list.size() && i < list1.size(); ++i) {
         ...
         Material material = new Material(p_228837_7_ ? Atlases.field_228744_c_ : Atlases.field_228745_d_, bannerpattern.func_226957_a_(p_228837_7_));
         p_228837_5_.func_228309_a_(p_228837_1_, material.func_229311_a_(p_228837_2_, RenderType::func_228650_h_), p_228837_3_, p_228837_4_, afloat[0], afloat[1], afloat[2], 1.0F);
      }
