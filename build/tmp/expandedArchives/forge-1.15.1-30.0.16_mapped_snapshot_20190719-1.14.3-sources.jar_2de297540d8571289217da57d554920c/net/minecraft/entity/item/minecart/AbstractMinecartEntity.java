...
public abstract class AbstractMinecartEntity extends Entity implements net.minecraftforge.common.extensions.IForgeEntityMinecart {
   ...
   protected void moveAlongTrack(BlockPos pos, BlockState state) {
      ...
      if (vec3i.getY() != 0 && MathHelper.floor(this.func_226277_ct_()) - pos.getX() == vec3i.getX() && MathHelper.floor(this.func_226281_cx_()) - pos.getZ() == vec3i.getZ()) {
         this.setPosition(this.func_226277_ct_(), this.func_226278_cu_() + (double)vec3i.getY(), this.func_226281_cx_());
      } else if (vec3i1.getY() != 0 && MathHelper.floor(this.func_226277_ct_()) - pos.getX() == vec3i1.getX() && MathHelper.floor(this.func_226281_cx_()) - pos.getZ() == vec3i1.getZ()) {
            ...
            if (!this.isPassenger(entityIn)) {
               ...
               if (d2 >= (double)1.0E-4F) {
                  ...
                  if (entityIn instanceof AbstractMinecartEntity) {
                     ...
                     double d5 = entityIn.func_226281_cx_() - this.func_226281_cx_();
