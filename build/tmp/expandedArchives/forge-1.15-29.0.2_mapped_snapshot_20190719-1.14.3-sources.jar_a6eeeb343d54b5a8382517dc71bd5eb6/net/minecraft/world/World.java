...
public abstract class World extends net.minecraftforge.common.capabilities.CapabilityProvider<World> implements IWorld, AutoCloseable, net.minecraftforge.common.extensions.IForgeWorld {
   ...
   public boolean addTileEntity(TileEntity tile) {
      if (tile.getWorld() != this) tile.func_226984_a_(this, tile.getPos()); // Forge - set the world early as vanilla doesn't set it until next tick
   ...
   public void addTileEntities(Collection<TileEntity> tileEntityCollection) {
      if (this.processingLoadedTiles) {
         tileEntityCollection.stream().filter(te -> te.getWorld() != this).forEach(te -> te.func_226984_a_(this, te.getPos())); // Forge - set the world early as vanilla doesn't set it until next tick
