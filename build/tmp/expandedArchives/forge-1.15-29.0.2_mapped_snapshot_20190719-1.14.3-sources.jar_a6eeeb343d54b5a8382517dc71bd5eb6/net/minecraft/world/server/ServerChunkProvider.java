...
public class ServerChunkProvider extends AbstractChunkProvider {
   ...
   public boolean isChunkLoaded(Entity entityIn) {
      long i = ChunkPos.asLong(MathHelper.floor(entityIn.func_226277_ct_()) >> 4, MathHelper.floor(entityIn.func_226281_cx_()) >> 4);
   ...
   public boolean func_223435_b(Entity p_223435_1_) {
      long i = ChunkPos.asLong(MathHelper.floor(p_223435_1_.func_226277_ct_()) >> 4, MathHelper.floor(p_223435_1_.func_226281_cx_()) >> 4);
