...
public class FaceBakery {
   ...
   public BakedQuad func_228824_a_(Vector3f p_228824_1_, Vector3f p_228824_2_, BlockPartFace p_228824_3_, TextureAtlasSprite p_228824_4_, Direction p_228824_5_, IModelTransform p_228824_6_, @Nullable BlockPartRotation p_228824_7_, boolean p_228824_8_, ResourceLocation p_228824_9_) {
      ...
      if (p_228824_6_.isUvLock()) {
         blockfaceuv = net.minecraftforge.client.ForgeHooksClient.applyUVLock(p_228824_3_.blockFaceUV, p_228824_5_, p_228824_6_.func_225615_b_(), p_228824_9_);
      }
      ...
      int[] aint = this.func_228820_a_(blockfaceuv, p_228824_4_, p_228824_5_, this.getPositionsDiv16(p_228824_1_, p_228824_2_), p_228824_6_.func_225615_b_(), p_228824_7_, p_228824_8_);
      ...
      return new BakedQuad(aint, p_228824_3_.tintIndex, direction, p_228824_4_, p_228824_8_, net.minecraft.client.renderer.vertex.DefaultVertexFormats.BLOCK);
   }
   ...
   private void func_228826_a_(int[] p_228826_1_, int p_228826_2_, Vector3f p_228826_3_, int p_228826_4_, TextureAtlasSprite p_228826_5_, BlockFaceUV p_228826_6_) {
      ...
      p_228826_1_[i + 4] = Float.floatToRawIntBits(p_228826_5_.getInterpolatedU((double)p_228826_6_.getVertexU(p_228826_2_)));
      p_228826_1_[i + 4 + 1] = Float.floatToRawIntBits(p_228826_5_.getInterpolatedV((double)p_228826_6_.getVertexV(p_228826_2_)));
