...
public abstract class LivingEntity extends Entity {
   ...
   protected LootContext.Builder getLootContextBuilder(boolean p_213363_1_, DamageSource damageSourceIn) {
      LootContext.Builder lootcontext$builder = (new LootContext.Builder((ServerWorld)this.world)).withRandom(this.rand).withParameter(LootParameters.THIS_ENTITY, this).withParameter(LootParameters.POSITION, this.func_233580_cy_()).withParameter(LootParameters.DAMAGE_SOURCE, damageSourceIn).withNullableParameter(LootParameters.KILLER_ENTITY, damageSourceIn.getTrueSource()).withNullableParameter(LootParameters.DIRECT_KILLER_ENTITY, damageSourceIn.getImmediateSource());
   ...
   public void travel(Vector3d p_213352_1_) {
      if (this.isServerWorld() || this.canPassengerSteer()) {
         ...
         if (this.isInWater() && this.func_241208_cS_() && !this.func_230285_a_(fluidstate.getFluid())) {
            ...
            float f5 = this.world.getBlockState(this.getPositionUnderneath()).getSlipperiness(world, this.getPositionUnderneath(), this);
            float f6 = 0.02F;
   ...
   private Vector3d handleOnClimbable(Vector3d p_213362_1_) {
      if (this.isOnLadder()) {
         ...
         if (d2 < 0.0D && !this.getBlockState().isIn(Blocks.SCAFFOLDING) && this.func_230491_ea_() && this instanceof PlayerEntity) {
            d2 = 0.0D;
         }
   ...
   public void wakeUp() {
      this.getBedPosition().filter(this.world::isBlockLoaded).ifPresent((p_241348_1_) -> {
         ...
         if (blockstate.isBed(world, getPositionUnderneath(), this)) {
            this.world.setBlockState(p_241348_1_, blockstate.with(BedBlock.OCCUPIED, Boolean.valueOf(false)), 3);
            Vector3d vector3d1 = BedBlock.func_220172_a(this.getType(), this.world, p_241348_1_, 0).orElseGet(() -> {
