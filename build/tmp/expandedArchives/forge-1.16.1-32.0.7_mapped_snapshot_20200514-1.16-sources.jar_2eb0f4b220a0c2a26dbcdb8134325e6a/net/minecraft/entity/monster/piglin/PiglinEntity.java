...
public class PiglinEntity extends MonsterEntity implements ICrossbowUser {
   ...
   private int field_234413_bz_ = 0;
   ...
   public void writeAdditional(CompoundNBT compound) {
      ...
      compound.putInt("TimeInOverworld", this.field_234413_bz_);
   ...
   public void readAdditional(CompoundNBT compound) {
      ...
      this.func_234441_t_(compound.getBoolean("IsImmuneToZombification"));
      this.func_234443_v_(compound.getBoolean("CannotHunt"));
      this.field_234413_bz_ = compound.getInt("TimeInOverworld");
   ...
   public void func_234441_t_(boolean p_234441_1_) {
   ...
   protected void updateAITasks() {
      ...
      if (this.func_234423_eL_()) {
         ++this.field_234413_bz_;
      } else {
         this.field_234413_bz_ = 0;
      }

      if (this.field_234413_bz_ > 300) {
   ...
   public PiglinEntity.Action func_234424_eM_() {
      if (this.func_234425_eN_()) {
         ...
         return this.isAggressive() && this.func_233631_a_(Items.CROSSBOW) ? PiglinEntity.Action.CROSSBOW_HOLD : PiglinEntity.Action.DEFAULT;
      }
   }
