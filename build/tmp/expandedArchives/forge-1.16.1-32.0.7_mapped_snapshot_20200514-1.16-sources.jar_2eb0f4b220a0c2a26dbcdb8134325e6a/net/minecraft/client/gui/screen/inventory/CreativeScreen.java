...
public class CreativeScreen extends DisplayEffectsScreen<CreativeScreen.CreativeContainer> {
   ...
   protected void func_230451_b_(MatrixStack p_230451_1_, int p_230451_2_, int p_230451_3_) {
      ...
      if (itemgroup != null && itemgroup.drawInForegroundOfTab()) {
         ...
         this.field_230712_o_.func_238421_b_(p_230451_1_, I18n.format(itemgroup.getTranslationKey()), 8.0F, 6.0F, itemgroup.getLabelColor());
      }
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      if (!rendered && !func_238809_a_(p_230430_1_, ItemGroup.SEARCH, p_230430_2_, p_230430_3_))
          func_238809_a_(p_230430_1_, ItemGroup.INVENTORY, p_230430_2_, p_230430_3_);
      ...
      if (maxPages != 0) {
          ...
          field_230712_o_.func_238407_a_(p_230430_1_, page, guiLeft + (xSize / 2) - (field_230712_o_.func_238414_a_(page) / 2), guiTop - 44, -1);
   ...
   protected boolean func_238809_a_(MatrixStack p_238809_1_, ItemGroup p_238809_2_, int p_238809_3_, int p_238809_4_) {
      ...
      if (this.isPointInRegion(j + 3, k + 3, 23, 27, (double)p_238809_3_, (double)p_238809_4_)) {
         this.func_238652_a_(p_238809_1_, new TranslationTextComponent(p_238809_2_.getTranslationKey()), p_238809_3_, p_238809_4_);
         return true;
      } else {
         return false;
      }
