...
public abstract class Screen extends FocusableGui implements IScreen, IRenderable {
   ...
   public void func_238652_a_(MatrixStack p_238652_1_, ITextProperties p_238652_2_, int p_238652_3_, int p_238652_4_) {
      this.func_238654_b_(p_238652_1_, Arrays.asList(p_238652_2_), p_238652_3_, p_238652_4_);
   }
   ...
   public void func_238654_b_(MatrixStack p_238654_1_, List<? extends ITextProperties> p_238654_2_, int p_238654_3_, int p_238654_4_, FontRenderer font) {
      ...
      if (false && !p_238654_2_.isEmpty()) {
         ...
         for(ITextProperties itextproperties : p_238654_2_) {
            int j = this.field_230712_o_.func_238414_a_(itextproperties);
            if (j > i) {
               i = j;
            }
         }
         ...
         for(int l1 = 0; l1 < p_238654_2_.size(); ++l1) {
            ...
            if (itextproperties1 != null) {
               this.field_230712_o_.func_238416_a_(itextproperties1, (float)i2, (float)j2, -1, true, matrix4f, irendertypebuffer$impl, false, 0, 15728880);
            }
         ...
         if (hoverevent$itemhover != null) {
            ...
            if (hoverevent$entityhover != null) {
               if (this.field_230706_i_.gameSettings.advancedItemTooltips) {
                  this.func_238654_b_(p_238653_1_, hoverevent$entityhover.func_240684_b_(), p_238653_3_, p_238653_4_);
               }
            } else {
