...
public class Ingredient implements Predicate<ItemStack> {
   ...
   public static Ingredient.IItemList deserializeItemList(JsonObject json) {
      if (json.has("item") && json.has("tag")) {
         ...
         ITag<Item> itag = TagCollectionManager.func_232928_e_().func_232925_b_().get(resourcelocation);
         if (itag == null) {
   ...
   public static class TagList implements Ingredient.IItemList {
      ...
      public Collection<ItemStack> getStacks() {
         ...
         if (list.size() == 0 && !net.minecraftforge.common.ForgeConfig.SERVER.treatEmptyTagsAsAir.get()) {
            list.add(new ItemStack(net.minecraft.block.Blocks.BARRIER).setDisplayName(new net.minecraft.util.text.StringTextComponent("Empty Tag: " + TagCollectionManager.func_232928_e_().func_232925_b_().func_232975_b_(this.tag).toString())));
         }
         return list;
      }
