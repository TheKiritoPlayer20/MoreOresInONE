...
public interface ITagCollectionSupplier extends net.minecraftforge.common.extensions.IForgeTagCollectionSupplier {
   ...
   static ITagCollectionSupplier reinjectOptionalTags(ITagCollectionSupplier tagCollectionSupplier) {
      ITagCollection<Block> blockTagCollection = BlockTags.collection.reinjectOptionalTags(tagCollectionSupplier.func_241835_a());
      ITagCollection<Item> itemTagCollection = ItemTags.collection.reinjectOptionalTags(tagCollectionSupplier.func_241836_b());
      ITagCollection<Fluid> fluidTagCollection = FluidTags.collection.reinjectOptionalTags(tagCollectionSupplier.func_241837_c());
      ITagCollection<EntityType<?>> entityTypeTagCollection = EntityTypeTags.tagCollection.reinjectOptionalTags(tagCollectionSupplier.func_241838_d());
      return new ITagCollectionSupplier() {
         @Override
         public ITagCollection<Block> func_241835_a() {
