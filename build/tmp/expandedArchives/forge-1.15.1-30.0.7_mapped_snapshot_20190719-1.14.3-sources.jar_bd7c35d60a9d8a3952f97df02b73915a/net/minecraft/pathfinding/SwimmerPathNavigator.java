...
public class SwimmerPathNavigator extends PathNavigator {
   ...
   public void tick() {
      ...
      if (!this.noPath()) {
         if (this.canNavigate()) {
            ...
            if (MathHelper.floor(this.entity.func_226277_ct_()) == MathHelper.floor(vec3d.x) && MathHelper.floor(this.entity.func_226278_cu_()) == MathHelper.floor(vec3d.y) && MathHelper.floor(this.entity.func_226281_cx_()) == MathHelper.floor(vec3d.z)) {
   ...
   protected void pathFollow() {
      if (this.currentPath != null) {
         ...
         // Forge: fix MC-94054
         if (Math.abs(this.entity.func_226277_ct_() - (vec3d2.x + ((this.entity.getWidth() + 1) / 2D))) < (double)f1 && Math.abs(this.entity.func_226281_cx_() - (vec3d2.z + ((this.entity.getWidth() + 1) / 2D))) < (double)f1 && Math.abs(this.entity.func_226278_cu_() - vec3d2.y) < (double)(f1 * 2.0F)) {
