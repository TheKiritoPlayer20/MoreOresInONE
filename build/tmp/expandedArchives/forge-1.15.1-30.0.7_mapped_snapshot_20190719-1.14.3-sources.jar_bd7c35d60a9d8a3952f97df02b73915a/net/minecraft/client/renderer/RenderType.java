...
public abstract class RenderType extends RenderState {
   ...
   public static RenderType func_228640_c_(ResourceLocation p_228640_0_) {
      RenderType.State rendertype$state = RenderType.State.func_228694_a_().func_228724_a_(new RenderState.TextureState(p_228640_0_, false, false)).func_228726_a_(field_228510_b_).func_228716_a_(field_228532_x_).func_228713_a_(field_228517_i_).func_228714_a_(field_228491_A_).func_228719_a_(field_228528_t_).func_228722_a_(field_228530_v_).func_228728_a_(true);
   ...
   public static RenderType func_228644_e_(ResourceLocation p_228644_0_) {
      RenderType.State rendertype$state = RenderType.State.func_228694_a_().func_228724_a_(new RenderState.TextureState(p_228644_0_, false, false)).func_228726_a_(field_228515_g_).func_228716_a_(field_228532_x_).func_228713_a_(field_228517_i_).func_228714_a_(field_228491_A_).func_228719_a_(field_228528_t_).func_228722_a_(field_228530_v_).func_228728_a_(true);
   ...
   public static final class State {
      ...
      private final boolean field_228692_p_;
      ...
      private State(RenderState.TextureState p_i225995_1_, RenderState.TransparencyState p_i225995_2_, RenderState.DiffuseLightingState p_i225995_3_, RenderState.ShadeModelState p_i225995_4_, RenderState.AlphaState p_i225995_5_, RenderState.DepthTestState p_i225995_6_, RenderState.CullState p_i225995_7_, RenderState.LightmapState p_i225995_8_, RenderState.OverlayState p_i225995_9_, RenderState.FogState p_i225995_10_, RenderState.LayerState p_i225995_11_, RenderState.TargetState p_i225995_12_, RenderState.TexturingState p_i225995_13_, RenderState.WriteMaskState p_i225995_14_, RenderState.LineState p_i225995_15_, boolean p_i225995_16_) {
         this.field_228677_a_ = p_i225995_1_;
         this.field_228678_b_ = p_i225995_2_;
         this.field_228679_c_ = p_i225995_3_;
         this.field_228680_d_ = p_i225995_4_;
         this.field_228681_e_ = p_i225995_5_;
         this.field_228682_f_ = p_i225995_6_;
         this.field_228683_g_ = p_i225995_7_;
         this.field_228684_h_ = p_i225995_8_;
         this.field_228685_i_ = p_i225995_9_;
         this.field_228686_j_ = p_i225995_10_;
         this.field_228687_k_ = p_i225995_11_;
         this.field_228688_l_ = p_i225995_12_;
         this.field_228689_m_ = p_i225995_13_;
         this.field_228690_n_ = p_i225995_14_;
         this.field_228691_o_ = p_i225995_15_;
         this.field_228692_p_ = p_i225995_16_;
      ...
      public boolean equals(Object p_equals_1_) {
         if (this == p_equals_1_) {
            ...
            return this.field_228692_p_ == rendertype$state.field_228692_p_ && this.field_228693_q_.equals(rendertype$state.field_228693_q_);
         } else {
            return false;
         }
      }
      ...
      public int hashCode() {
         return Objects.hash(this.field_228693_q_, this.field_228692_p_);
      }
   ...
   static final class Type extends RenderType {
      ...
      private Type(String p_i225993_1_, VertexFormat p_i225993_2_, int p_i225993_3_, int p_i225993_4_, boolean p_i225993_5_, boolean p_i225993_6_, RenderType.State p_i225993_7_) {
         ...
         this.field_228670_U_ = p_i225993_7_.field_228692_p_ ? p_i225993_7_.field_228677_a_.func_228606_c_().map(RenderType::func_228654_j_) : Optional.empty();
