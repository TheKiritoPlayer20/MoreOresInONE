...
public abstract class HangingEntity extends Entity {
      ...
      if (!this.world.func_226669_j_(this)) {
         ...
         for(int k = 0; k < i; ++k) {
            for(int l = 0; l < j; ++l) {
               ...
               if (net.minecraft.block.Block.func_220055_a(this.world, blockpos$mutable, this.facingDirection))
                  continue;
   ...
   public ItemEntity entityDropItem(ItemStack stack, float offsetY) {
      ItemEntity itementity = new ItemEntity(this.world, this.func_226277_ct_() + (double)((float)this.facingDirection.getXOffset() * 0.15F), this.func_226278_cu_() + (double)offsetY, this.func_226281_cx_() + (double)((float)this.facingDirection.getZOffset() * 0.15F), stack);
