...
public abstract class PlayerEntity extends LivingEntity {
   ...
   private boolean bedInRange(BlockPos p_190774_1_, Direction p_190774_2_) {
      if (Math.abs(this.func_226277_ct_() - (double)p_190774_1_.getX()) <= 3.0D && Math.abs(this.func_226278_cu_() - (double)p_190774_1_.getY()) <= 2.0D && Math.abs(this.func_226281_cx_() - (double)p_190774_1_.getZ()) <= 3.0D) {
         return true;
      } else if (p_190774_2_ == null) {
         return false;
      } else {
         BlockPos blockpos = p_190774_1_.offset(p_190774_2_.getOpposite());
         return Math.abs(this.func_226277_ct_() - (double)blockpos.getX()) <= 3.0D && Math.abs(this.func_226278_cu_() - (double)blockpos.getY()) <= 2.0D && Math.abs(this.func_226281_cx_() - (double)blockpos.getZ()) <= 3.0D;
      }
   }
