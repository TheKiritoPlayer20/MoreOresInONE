...
public class Minecraft extends RecursiveEventLoop<Runnable> implements ISnooperInfo, IWindowEventListener {
   ...
   public void func_238192_a_(String p_238192_1_, WorldSettings p_238192_2_, IDynamicRegistries.Impl p_238192_3_, DimensionGeneratorSettings p_238192_4_) {
      this.func_238195_a_(p_238192_1_, p_238192_3_, (p_238179_1_) -> {
         ...
         DataResult<SimpleRegistry<Dimension>> dataresult = worldsettingsimport.func_241797_a_(p_238192_4_.func_236224_e_(), Registry.field_239700_af_, Dimension.field_236052_a_);
   ...
   public Minecraft.PackManager func_238189_a_(IDynamicRegistries.Impl p_238189_1_, Function<SaveFormat.LevelSave, DatapackCodec> p_238189_2_, Function4<SaveFormat.LevelSave, IDynamicRegistries.Impl, IResourceManager, DatapackCodec, IServerConfiguration> p_238189_3_, boolean p_238189_4_, SaveFormat.LevelSave p_238189_5_) throws InterruptedException, ExecutionException {
      ...
      ResourcePackList<ResourcePackInfo> resourcepacklist = new ResourcePackList<>(ResourcePackInfo::new, new ServerPackFinder(), new FolderPackFinder(p_238189_5_.func_237285_a_(FolderName.field_237251_g_).toFile(), IPackNameDecorator.field_232627_c_));
