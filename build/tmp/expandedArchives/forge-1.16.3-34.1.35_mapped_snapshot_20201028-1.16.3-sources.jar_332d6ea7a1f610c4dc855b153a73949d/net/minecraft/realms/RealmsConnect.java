      ...
      (new Thread("Realms-connect-task") {
         public void run() {
            ...
            try {
               ...
               DisconnectedRealmsScreen disconnectedrealmsscreen = new DisconnectedRealmsScreen(RealmsConnect.this.field_230720_b_, DialogTexts.CONNECTION_FAILED, new TranslationTextComponent("disconnect.genericReason", "Unknown host '" + p_231397_1_ + "'"));
               minecraft.execute(() -> {
