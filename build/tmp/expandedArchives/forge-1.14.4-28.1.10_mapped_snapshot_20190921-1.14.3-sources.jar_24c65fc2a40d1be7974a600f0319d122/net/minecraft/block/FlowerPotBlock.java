...
public class FlowerPotBlock extends Block {
   ...
   private final net.minecraftforge.registries.IRegistryDelegate<Block> flower;

   @Deprecated // Mods should use the constructor below
   public FlowerPotBlock(Block p_i48395_1_, Block.Properties p_i48395_2_) {
      this((FlowerPotBlock) Blocks.FLOWER_POT, p_i48395_1_, p_i48395_2_);
   }
   ...
   public FlowerPotBlock(FlowerPotBlock emptyPot, Block p_i48395_1_, Block.Properties p_i48395_2_) {
      super(p_i48395_2_);
      this.flower = p_i48395_1_.delegate;
      if (emptyPot == null) {
   ...
   public boolean onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
      ...
      Block block = item instanceof BlockItem ? fullPots.getOrDefault(((BlockItem)item).getBlock().delegate, Blocks.AIR.delegate).get() : Blocks.AIR;
      boolean flag = block == Blocks.AIR;
      boolean flag1 = this.flower.get() == Blocks.AIR;
      if (flag != flag1) {
         if (flag1) {
            ...
            ItemStack itemstack1 = new ItemStack(this.flower.get());
            ...
            worldIn.setBlockState(pos, emptyPot.getDefaultState(), 3);
         }
      }
   ...
   public ItemStack getItem(IBlockReader worldIn, BlockPos pos, BlockState state) {
      return this.flower.get() == Blocks.AIR ? super.getItem(worldIn, pos, state) : new ItemStack(this.flower.get());
   }
