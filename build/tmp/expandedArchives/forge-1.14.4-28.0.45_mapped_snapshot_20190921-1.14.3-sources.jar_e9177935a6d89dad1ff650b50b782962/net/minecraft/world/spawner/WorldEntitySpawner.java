                  ...
                  label115: {
                     if (k2 < i2) {
                        label123: {
                           ...
                           int canSpawn = net.minecraftforge.common.ForgeHooks.canEntitySpawn(mobentity, worldIn, f, k, f1, null);
                           ...
                           if (!net.minecraftforge.event.ForgeEventFactory.doSpecialSpawn(mobentity, worldIn, f, k, f1, null))
