...
public class Ingredient implements Predicate<ItemStack> {
   ...
   protected Ingredient(Stream<? extends Ingredient.IItemList> itemLists) {
      ...
      this.isSimple = !net.minecraftforge.fml.ModLoader.isDataGenRunning() && !Arrays.stream(acceptedItems).anyMatch(list -> list.getStacks().stream().anyMatch(stack -> stack.getItem().isDamageable(stack)));
