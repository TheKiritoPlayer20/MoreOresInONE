   ...
   public Entity changeDimension(ServerWorld p_241206_1_, net.minecraftforge.common.util.ITeleporter teleporter) {
      ...
      if (registrykey == World.field_234920_i_ && p_241206_1_.func_234923_W_() == World.field_234918_g_ && teleporter instanceof net.minecraft.world.Teleporter) { //Forge: Fix non-vanilla teleporters triggering end credits
         ...
         if (p_241206_1_.func_234923_W_() == World.field_234920_i_) {
            ...
            DimensionType dimensiontype = p_241206_1_.func_230315_m_();
            double d3 = 8.0D;
         ...
         double d6 = Math.min(-2.9999872E7D, p_241206_1_.getWorldBorder().minX() + 16.0D);
         double d7 = Math.min(-2.9999872E7D, p_241206_1_.getWorldBorder().minZ() + 16.0D);
         double d4 = Math.min(2.9999872E7D, p_241206_1_.getWorldBorder().maxX() - 16.0D);
         double d5 = Math.min(2.9999872E7D, p_241206_1_.getWorldBorder().maxZ() - 16.0D);
         ...
         } else if (spawnPortal && !p_241206_1_.getDefaultTeleporter().placeInPortal(this, f2)) {
            p_241206_1_.getDefaultTeleporter().makePortal(this);
            p_241206_1_.getDefaultTeleporter().placeInPortal(this, f2);
         }
