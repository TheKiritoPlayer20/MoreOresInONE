        ...
        if(silktouch == 0){
                if(fortune != 0 && Config.enableFortune.get()) {
                    if (random.nextInt(101) >= 50) {
                        int experience = Mth.nextInt(random, Config.min_exp_nether.get(),Config.max_exp_nether.get());
                    ...
                    if (random.nextInt(101) >= 50) {
                        return Mth.nextInt(random, Config.min_exp_nether.get(),Config.max_exp_nether.get());
                    }else{
                        return 1;
                    }
                }
